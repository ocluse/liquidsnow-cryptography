namespace Ocluse.LiquidSnow.Cryptography.Symmetrics
{
    ...
    public static class SymmetricBuilder
    {
        ...
        {
            return Create(EncryptionAlgorithm.Aes, CryptoUtility.GenerateId(IdKind.Standard, 16));
        }
        ...
        {
            return Create(EncryptionAlgorithm.Rijndael, CryptoUtility.GenerateId(IdKind.Standard, 16));
        }
